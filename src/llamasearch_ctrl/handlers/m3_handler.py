...
class M3OptimizedHandler(Handler):
            ...
            for chunk in response_iterator:
                ...
                if chunk_finish_reason:
                    ...
                    if finish_reason == "tool_calls":
                        final_tool_calls = self._normalize_tool_calls(
                        ...
                        if final_tool_calls:
                            ...
                            if len(final_tool_calls) > 1 and self._is_m3_max:
                                ...
                                yield from self._handle_function_call(
                                    messages, final_tool_calls
                                )
    ...
    def _execute_tool_call_thread(
        ...
        try:
            ...
            result = (
                f"Error during function execution: {type(e_exec).__name__}: {e_exec}"
            )
