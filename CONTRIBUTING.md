# Contributing to Llama Ctrl

Thank you for your interest in contributing to Llama Ctrl! This document provides guidelines and instructions for contributing to this project.
...
There are many ways to contribute to Llama Ctrl:
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/llama-ctrl.git
   cd llama-ctrl
   ```

3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llama-ctrl.git
   ```
...
By contributing to Llama Ctrl, you agree that your contributions will be licensed under the project's MIT License.
